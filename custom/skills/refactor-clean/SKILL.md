...
description: |
  ...
  This skill should be used when cleaning up unused code, removing dead imports, or finding unused components, or when user mentions "미사용 코드 정리", "죽은 코드", "안 쓰는 코드", "cleanup unused", "remove dead code".
